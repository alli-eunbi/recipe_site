...
img_to_detect = cv2.imread('test_paprika.jpg')
...
# only single label 
class_labels = ["paprika", 'bell pepper', 'romaine']
...
yolo_model = cv2.dnn.readNetFromDarknet('./yolov4/darknet_master/yolov4_3_classes.cfg', './yolov4/darknet_master/yolov4_3_classes.weights')
